...
At TIKI (Technologisches Institut für angewandte Künstliche Intelligenz GmbH), I worked as an **AI Developer & Data Scientist** on deep-learning-based image classification.
...
### [Benchmark Model Implementation: Smart Persistence Model](https://github.com/Felix561/smart-persistence-model)
Implemented a Python version of the Smart Persistence Model (SPM) as a benchmark baseline for short-term PV forecasting.

## Research & Experiments (ARC-AGI context)
### [MDL-ARK](https://github.com/Felix561/MDL-ARK)
- Experiment-focused work related to ARC-style reasoning tasks and benchmarking.
- Supports practical exploration of model behavior and evaluation setups.
